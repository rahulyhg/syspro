...
class Settings extends MX_Controller {
    ...
    public function update() {
        ...
        if (!empty($email)) {
            ...
            // Validating Currency Field   
            $this->form_validation->set_rules('logo', 'Logo', 'trim|min_length[1]|max_length[3]|xss_clean');
            ...
            $this->session->set_flashdata('feedback', 'Email Requeridos!');
    ...
    function backup_database() {
        ...
        $this->session->set_flashdata('message', 'Backup de banco de dados bem sucedido!');
    ...
    function backup_files() {
        ...
        $this->session->set_flashdata('message', 'Backup de aplicativos com sucesso!');
        redirect("settings/backups");
        exit();
    }
    ...
    function restore_database($dbfile) {
        ...
        $this->session->set_flashdata('message', 'Restauração do backup bem sucedido!');
        redirect('settings/backups');
    }
    ...
    function restore_backup($zipfile) {
        ...
        $this->sma->unzip($file, './');
        $this->session->set_flashdata('info', 'Restauração do aplicativo bem sucedido');
        redirect("settings/backups");
        exit();
    }
    ...
    function delete_database($dbfile) {
        ...
        $this->session->set_flashdata('info', 'Exclusão do banco de dados com sucesso');
        redirect("settings/backups");
    }
    ...
    function delete_backup($zipfile) {
        ...
        $this->session->set_flashdata('info', 'Exclusão de backup de aplicativo com sucesso');
        redirect("settings/backups");
    }
