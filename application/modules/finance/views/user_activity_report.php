                    ...
                    <section class="col-md-6 no-print">
                        <form role="form" class="f_report" action="finance/userActivityReportDateWise" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div id="formulario-data-inicio-final" class="input-group input-large" data-date="13/12/2017" data-date-format="mm/dd/yyyy">
                    ...
                    <section class="col-md-6">
                        <form role="form" class="f_report" action="finance/allUserActivityReportDateWise" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <!--     <label class="control-label col-md-3">Date Range</label> -->
                                <div class="col-md-6">
                                    <div id="formulario-data-inicio-final" class="input-group input-large" data-date="13/07/2013" data-date-format="mm/dd/yyyy">
                                        <input type="text" class="form-control dpd1" name="date_from" value="<?php
                                        if (!empty($date_from)) {
                                            echo date('m/d/Y', $date_from);
                                        }
