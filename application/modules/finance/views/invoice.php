Número da Fatura: <!--main content start-->
                ...
                <div class="panel-body col-md-5" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <div class="col-lg-4 col-sm-4" style="float: left;">
                            ...
                            <ul class="unstyled">
                                <li>Número da Fatura: 		: <strong>000<?php echo $payment->id; ?></strong></li>
                                <li>Data		: <?php echo date('m/d/Y', $payment->date); ?></li>
                            </ul>
                             <?php if (!empty($payment->doctor)) { ?>
                            <span><strong>Referido pelo médico:</strong></span> <span><?php echo $this->db->get_where('doctor', array('id' => $payment->doctor))->row()->name ?></span>
                        <?php } ?>
                        </div>
                        <br>
