                            ...
                            <?php foreach ($medical_histories as $medical_history) { ?>
                                <tr class="">
                                    ...
                                    <td class="no-print">
                                        ...
                                        <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="patient/deleteCaseHistory?id=<?php echo $medical_history->id; ?>&redirect=case" onclick="return confirm('Tem certeza de que deseja excluir este item?');"><i class="fa fa-trash-o"></i> </a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
